...
class NeoPatterns : public Adafruit_NeoPixel
{
  public:
    ...
    unsigned long startCycle; // millisecond when current lightning cycle pattern started
    ...
    {
      uint16_t delayMultiplier = random(40, 100);
...
//         Serial.println("startCycle fired.");
...
//          Serial.println("lighting case 0");
          ...
          lastCycle = n;
          rumbleTicker = 0;
//          Serial.print("Interval x 40:");
//            Serial.println(Interval * 40);
//              Serial.print("millis - startCycle:");
//            Serial.println(millis() - startCycle);
          if((millis() - startCycle) < (Interval * delayMultiplier)) {
            nextStep = 0;
//            Serial.println("Cycle 0 If");
          } else {
            nextStep = 1;
//            Serial.println("Cycle 0 Else");
          }
...
//            Serial.println("lightning case 1.2");
            ...
            if(rumbleTicker < 3) {
//                Serial.println("lightning case 1.2.1");
                isComplete = 0;
                lastCycle = n;
                nextStep++;
              } else if ((rumbleTicker >= 3) && (rumbleTicker < 15)) {
//                Serial.println("lightning case 1.2.2");
                isComplete = random(0,1);
                lastCycle = n;
                nextStep++;
              } else {
                isComplete = 1;
              ...
              rumbleTicker++;
//              Serial.print("rumbleTicker: ");
//              Serial.println(rumbleTicker);
          } else {
...
//      Serial.println(n);
     ...
     uint16_t SwitchPicker(uint16_t isComplete, uint16_t lastCycle, uint16_t nextStep) {
      uint16_t switchNum;
//      Serial.print("Switch isComplete received:");
//      Serial.println(isComplete);
//      Serial.print("Switch lastCycle received:");
//      Serial.println(lastCycle);
//      Serial.print("Switch nextStep received:");
//      Serial.println(nextStep);
      if((Index == 0) || (isComplete == 1)) {
          if((lastCycle == 1) && (rumbleTicker >= 10)) {
            switchNum = 2;
//            Serial.println("Trigger big boom");
          } else {
            switchNum = 0;
          }
//          Serial.println("SwitchPicker If");
            ...
            switchNum = lastCycle;
        } else if ((lastCycle == 1) && (isComplete != 1)) {
          switchNum = lastCycle;
