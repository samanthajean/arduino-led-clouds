  ...
  <div class="container">
    ...
    <div class="col-8">
      ...
      <div class="d-grid gap-2 d-md-block">
        <button type="button" class="btn btn-outline-primary btn-sm" onclick="triggerPattern(0)">Solid</button>
        <button type="button" class="btn btn-outline-success btn-sm" onclick="triggerPattern(1)">Rainbow Cycle</button>
        <button type="button" class="btn btn-outline-warning btn-sm" onclick="triggerPattern(3)">Lightning</button>
        <button type="button" class="btn btn-outline-info btn-sm" onclick="triggerPattern(4)">Breath Sync</button>
      </div>
    </div>
     <div class="col-4">
...
//          var color3Hex = cloudParams.color3;
     ...
     function sendJson() {
      var json_data = '{"ledState": '+ledStatus+', "currPattern" : '+currPattern+'}';
